...
const Index = () => {
  return (
    <Container maxW="container.xl" p={0} minH="100vh" display="flex" flexDirection="column" justifyContent="space-between">
      <Box>
      ...
      <Box as="footer" bg="green.500" color="white" py={4} textAlign="center">
        <Text fontSize="sm">© 2023 VC Firm. All rights reserved.</Text>
      </Box>
    </Container>
  );
};
